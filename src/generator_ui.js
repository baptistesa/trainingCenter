...
function createHTML_selectdataModel() {//#container
    ...
    <img style="height: 30px;" src="../img/icons/backButton.png">
</div>
<div class="titleBlock" style="display: inline-block;">
    <h3>Training center</h3>
    <p>Select a data model</p>
</div>
...
function createHTML_selectFormat() {//#container
    ...
    <div>
    <div id="selectFormat" style="margin-top: 15%">
        <div class="title">
            Select a Dataset
        </div>
        <div class="tiles">
